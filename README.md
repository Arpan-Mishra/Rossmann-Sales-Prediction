...
Check out the webapp [here](http://34.229.29.5:8501/)
...
- Finally, the app has been deployed using AWS EC2 Instance and can be accessed [here](http://34.229.29.5:8501/)
